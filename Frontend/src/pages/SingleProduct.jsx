...
const SingleProduct = () => {
    ...
    const { ImageLink: img, Title: title, Description, Price, Company: company, Colors: colors } = product.attributes;
        ...
        <Wrapper>
            ...
            <div>
                ...
                <div className="section">
                    ...
                    {/* CART BUTTON */}
                    <button className="cartButton" onClick={() => console.log('added to cart')}>
                        <CartIcon />
                        <p>Add to cart</p>
                    </button>
                </div>
