    ...
    return (
        <Wrapper style={{ backgroundImage: `url(${kaseBgImage})` }} className="filterFormBG">
            <div className="formWrapper" >
                <Form>
                    {/* SEARCH */}
                    <FormInput type='search' name='Title' id='searchInput' label='search product' defaultValue={Title} />
                    ...
                    <div className="otherFilters">
                        ...
                        {/* PRICE */}
                        {/* <FormRange label='Price' name='Price' labelClassName='filterLabel' inputClassName='pricerange' intervalClassName='interval' Price={Price} /> */}
                    </div>
